...
function die_nicely($strTemplate, $strFallback)
{
	...
	elseif (file_exists(TL_ROOT . "/vendor/contao/module-core/legacy/templates/backend/$strTemplate.html5"))
	{
		include TL_ROOT . "/vendor/contao/module-core/legacy/templates/backend/$strTemplate.html5";
	}
	else
	{
		echo $strFallback;
